...
export const getScenePositionForSun = (
  ...
  const sunPositionCartesian = CesiumMatrix3.multiplyByVector(
    transformMatrix,
    sunPositionInEarthInertialFrame,
    new Cartesian3()
  );
  return getScenePositionForCartesian(sceneCenter, sceneCenterCartesian, sunPositionCartesian);
};

export const getSceneDirectionForSun = (
  sceneCenter: Vector3,
  sceneCenterCartesian: Cartesian3,
  date: Date = new Date()
): Vector3 => {
