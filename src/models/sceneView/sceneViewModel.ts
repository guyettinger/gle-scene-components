...
import {
  ...
  SceneViewBackgroundProps,
  SceneViewExtension,
  SceneViewForegroundExtension,
  SceneViewForegroundProps,
} from '../../extensions';
...
export class SceneViewModel {
  ...
  moveCameraToLongitudeLatitudeHeight(
    ...
    this.sceneModel.getScenePositionForLongitudeLatitudeHeight(
  ...
  getScenePositionForSun = (date: Date = new Date()): Vector3 => {
    return getScenePositionForSun(
      this.sceneModel.sceneCenter,
  ...
  getSceneDirectionForSun = (date: Date = new Date()): Vector3 => {
    return getSceneDirectionForSun(
      this.sceneModel.sceneCenter,
      this.sceneModel.sceneCenterCartesian,
      date
    );
