...
import {
  defaultSceneExtensionGenerator,
  SceneExtension,
  SceneExtensionGenerator,
} from '../../extensions';
...
export class SceneModel {
  ...
  constructor(public sceneProperties: SceneProps) {
    // scene name
    this.name = sceneProperties.name;

    // scene center
    this.sceneCenterLongitudeLatitudeHeight = convertVector3Prop(
      this.sceneProperties.sceneCenterLongitudeLatitudeHeight
    );
    ...
    // scene extensions
    this.sceneExtensionGenerator =
      sceneProperties.sceneExtensionGenerator ?? defaultSceneExtensionGenerator;
